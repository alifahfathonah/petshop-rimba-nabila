...
<div class="table-responsive table-resp">
  ...
  <table class="table table-hover scroll-table " >
    ...
    <tbody>
      ...
      <td class="">
        <a href="/barang/{{$item->kd_brg}}/edit" class="btn btn-primary btn-sm w-auto" role="button"><i class="fa fa-edit"></i>  Ubah</a> <br>
        <a href="/stok/{{$item->kd_brg}}/edit" class="btn btn-success btn-sm w-auto my-1" role="button"><i class="fa fa-plus-circle"></i>  Stok</a> <br>
        <button  type="button" class="btn btn-danger btn-sm  w-75" role="button" data-toggle="modal" data-target="#exampleModalCenter{{$item->kd_brg}}">
...
<div class="pagination-wrapper">
    {{$dt_bar->appends(Request::only('BarSearch'))->links()}}
</div>
